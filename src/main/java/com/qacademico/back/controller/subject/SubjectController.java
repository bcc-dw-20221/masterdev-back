...
public class SubjectController {
    ...
    @PutMapping("/add-professor/{subjectId}/{professorId}")
    @ResponseStatus(HttpStatus.OK)
    public SubjectResponse addProfessorToSubjectById(@PathVariable("subjectId") UUID subjectId,
                                                     @PathVariable("professorId") UUID professorId){
        var subject =subjectService.addProfessorToSubject(subjectId, professorId);
        return new SubjectResponse().fromSubject(subject);
    }
